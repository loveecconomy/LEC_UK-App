    ...
    <nav id="main-nav" class="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-lg border-b border-gray-200 transition-all duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-4 lg:px-4">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden lg:flex items-center space-x-2">
                    ...
                    <a href="{{ route('job.index')}}" class="px-5 py-2.5 text-gray-900 transition-colors font-medium rounded-lg hover:bg-gray-50">Job</a>
        ...
        <div id="mobile-menu" class="hidden lg:hidden bg-white border-t border-gray-200">
            <div class="px-4 py-6 space-y-3">
                ...
                <a href="{{ route('job.index')}}" class="block text-white px-6 py-3 rounded-full transition-colors font-semibold text-center mt-4 custom-blue-bg">Job</a>
            </div>
        </div>
    </nav>
